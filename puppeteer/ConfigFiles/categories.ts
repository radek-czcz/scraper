...
let urlArr = [
    ...
    {url: 'https://www.mediaexpert.pl/komputery-i-tablety/klawiatury-komputerowe/klawiatury/logitech.microsoft.hp.samsung.dell.asus.ibox/komunikacja-z-komputerem_bezprzewodowa?sort=price_asc',
    category: 'Klawiatury',
    seller: 'www.mediaexpert.pl'},
    ...
    // {url: 'https://www.whirlpool.pl/urzadzenia/zmywanie/zmywarki?initialMap=c,c,c&initialQuery=urzadzenia/zmywanie/zmywarki&map=category-1,category-2,category-3,liczba-kompletow-naczyn-,liczba-kompletow-naczyn-,typ-instalacji-&page=3&query=/urzadzenia/zmywanie/zmywarki/10/ponad-12/w-pe%C5%82ni-zintegrowane&searchState',
    // category: 'Zmywarki',
    // seller: 'www.whirlpool.pl'}
    
].filter((filtered:ISitesAndCategories) => filtered.seller === seller)

interface ISitesAndCategories {
    url:string;
    category:string;
    seller:string
}
...
export { map, urlArr, ISitesAndCategories }