...
import { loadPuppeteer, loadPage, getPage, getBrowserFromParentProcess, getPu, refreshPage } from '../index';
...
export { spawn, loadPuppeteer, loadPage, getPage, attachFunc, getTime, getBrowserFromParentProcess,
		writerDB, getPu, dateToSqlFormat, dateToClockTime, timingFunctions, CarData, refreshPage }